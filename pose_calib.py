...
def main():
    ...
    parser.add_argument("calibconfig", help="path to calibration configuration (e.g. data/calib_config.yml)")
    ...
    cfg = cv2.FileStorage(args.calibconfig, cv2.FILE_STORAGE_READ)
    assert cfg.isOpened()
